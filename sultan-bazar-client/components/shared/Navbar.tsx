            ...
            <div className="container mx-auto px-4 lg:px-8">
                <div className="flex items-center justify-between h-16 gap-4">
                    ...
                    <div className="flex items-center gap-2">
                        ...
                        <Link
                            href="/wishlist"
                            className="hidden sm:flex p-2 text-gray-600 hover:text-[#B5451B] transition-colors relative"
                        >
                        ...
                        <Link
                            href="/cart"
                            className="p-2 text-gray-600 hover:text-[#B5451B] transition-colors relative"
                        >
                        ...
                        <Button
                            size="sm"
                            className="hidden sm:flex items-center gap-1.5 text-white text-sm font-medium rounded-full px-4"
                            ...
                            <SheetContent side="left" className="w-72 p-0">
                                <div className="flex flex-col h-full">
                                    ...
                                    <div className="flex items-center gap-2 px-6 py-5 border-b" style={{ borderColor: "#B5451B20" }}>
                                        <span className="text-2xl">🪔</span>
                                        <span className="text-xl font-extrabold" style={{ color: "#B5451B" }}>
                                            Sultan Bazar
                                        </span>
                                    </div>
